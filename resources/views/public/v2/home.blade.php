...
<div
    ...
    <div class="start-screen__slide">
        <div class="start-screen__bg" style="background-image: url({{asset('template/v2/img/home_img/img_7.jpg')}});background-position: top 30% right 30%;"></div>
    ...
    <div class="start-screen__slide">
        <div class="start-screen__bg" style="background-image: url({{asset('template/v2/img/home_img/img_8.jpg')}});background-position: top 30% left 70%;"></div>
    ...
    <div class="start-screen__slide">
        <div class="start-screen__bg" style="background-image: url({{asset('template/v2/img/home_img/img_9.jpg')}});"></div>
...
<main role="main">
                ...
                <div class="__inner">
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-4">
                            <a class="__item" href="#"><img src="{{asset('template/v2/img/promo-banners_img/1.jpg')}}" alt="demo" class="img-fluid w-100" /></a>
                        </div>

                        <div class="col-12 col-md-6 col-lg-4">
                            <a class="__item" href="#"><img src="{{asset('template/v2/img/promo-banners_img/2.jpg')}}" alt="demo" class="img-fluid w-100" /></a>
                        </div>

                        <div class="col-12 col-md-6 col-lg-4">
                            <a class="__item" href="#"><img src="{{asset('template/v2/img/promo-banners_img/3.jpg')}}" alt="demo" class="img-fluid w-100" /></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section">
        <div class="decor-el decor-el--1" data-jarallax-element="-70" data-speed="0.2">
            <img class="lazy" width="286" height="280" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/decor-el_1.jpg')}}" alt="demo"/>
        </div>

        <div class="decor-el decor-el--2" data-jarallax-element="-70" data-speed="0.2">
            <img class="lazy" width="99" height="88" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/decor-el_2.jpg')}}" alt="demo"/>
        </div>

        <div class="decor-el decor-el--3" data-jarallax-element="-70" data-speed="0.2">
            <img class="lazy" width="115" height="117" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/decor-el_3.jpg')}}" alt="demo"/>
        </div>

        <div class="decor-el decor-el--4" data-jarallax-element="-70" data-speed="0.2">
            <img class="lazy" width="84" height="76" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/decor-el_4.jpg')}}" alt="demo"/>
        </div>

        <div class="decor-el decor-el--5" data-jarallax-element="-70" data-speed="0.2">
            <img class="lazy" width="248" height="309" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/decor-el_5.jpg')}}" alt="demo"/>
        </div>
                ...
                <div class="js-slick"
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="188" src="{{asset('template/v2/img/goods_img/1.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="180" src="{{asset('template/v2/img/goods_img/2.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="160" src="{{asset('template/v2/img/goods_img/3.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="190" src="{{asset('template/v2/img/goods_img/4.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="180" src="{{asset('template/v2/img/goods_img/5.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="180" src="{{asset('template/v2/img/goods_img/6.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="250" src="{{asset('template/v2/img/goods_img/7.jpg')}}" alt="demo" />
                        </figure>
                    ...
                    <div class="__item">
                        <figure class="__image">
                            <img width="236" src="{{asset('template/v2/img/goods_img/8.jpg')}}" alt="demo" />
                        </figure>
        ...
        <div class="container-fluid px-md-0">
            ...
            <div class="simple-banner simple-banner--style-2" data-aos="fade" data-aos-offset="50">
                <div class="d-none d-lg-block">
                    <img class="img-logo img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/site_logo.png')}}" alt="demo" />
                </div>

                <div class="row no-gutters">
                    <div class="col-12 col-lg-6">
                        <a href="#"><img class="img-fluid w-100  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/banner_bg_3.jpg')}}" alt="demo" /></a>
                    </div>

                    <div class="col-12 col-lg-6">
                        <a href="#"><img class="img-fluid w-100  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/banner_bg_4.jpg')}}" alt="demo" /></a>
                    </div>
                </div>
            </div>
            <!-- end banner simple -->
    ...
    <section class="section">
        <div class="d-none d-lg-block">
            <img id="bg-img-1" class="img-fluid lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/agro_2.png')}}" alt="demo" />
            <style type="text/css">
                #bg-img-1
                {
                    position: absolute;
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-5 col-lg-4">
                    <div class="section-heading section-heading--left" data-aos="fade">
                        <p>
                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/logo_small.png')}}" width="50" height="50" alt="demo" />
                        </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="100" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/7.png')}}" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="200" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/8.png')}}" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="300" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/9.png')}}" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="400" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/10.pn')}}g" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="500" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/11.pn')}}g" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="600" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/12.pn')}}g" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="700" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/13.pn')}}g" alt="demo" />
                                        </i>
                                ...
                                <div class="col-6 col-sm-4 col-lg-3">
                                    <div class="__item  text-center" data-aos="fade" data-aos-delay="800" data-aos-offset="100">
                                        <i class="__ico">
                                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/feature_img/14.pn')}}g" alt="demo" />
                                        </i>
                            ...
                            <div class="__item">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <figure class="__image">
                                            <img class="lazy" width="150" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/7.jpg')}}" alt="demo" />
                                        </figure>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-5 col-xl-4">
                            <div class="__item">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <figure class="__image">
                                            <img class="lazy" width="130" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/1.jpg')}}" alt="demo" />
                                        </figure>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-5 col-xl-4">
                            <div class="__item">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <figure class="__image">
                                            <img class="lazy" width="130" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/2.jpg')}}" alt="demo" />
                                        </figure>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-5 col-xl-4">
                            <div class="__item">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <figure class="__image">
                                            <img class="lazy" width="140" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/4.jpg')}}" alt="demo" />
                                        </figure>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-5 col-xl-4">
                            <div class="__item">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <figure class="__image">
                                            <img class="lazy" width="140" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/5.jpg')}}" alt="demo" />
                                        </figure>
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-5 col-xl-4">
                            <div class="__item">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <figure class="__image">
                                            <img class="lazy" width="160" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/8.jpg')}}" alt="demo" />
                                        </figure>
                                    </div>
                ...
                <div class="__inner">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="__item">
                                <figure class="__image">
                                    <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/1_1.jpg')}}" alt="demo" />
                                </figure>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="__item">
                                <figure class="__image">
                                    <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/1_2.jpg')}}" alt="demo" />
                                </figure>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="__item">
                                <figure class="__image">
                                    <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/1_3.jpg')}}" alt="demo" />
                                </figure>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="__item">
                                <figure class="__image">
                                    <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/1_4.jpg')}}" alt="demo" />
                                </figure>
        ...
        <div class="simple-banner simple-banner--style-1" data-aos="fade" data-aos-offset="50">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="__inner">
                            <img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/site_logo.png')}}" alt="demo" />
    ...
    <!-- start section -->
    <section class="section section--review  lazy" data-src="{{asset('template/v2/img/review_bg_1.png')}}">
        <div class="container">
            <div class="section-heading section-heading--center" data-aos="fade">
                        ...
                        <div class="review__item__author  d-table">
                            <div class="d-table-cell align-middle">
                                <div class="review__item__author-image">
                                    <img class="circled" src="{{asset('template/v2/img/ava.png')}}" alt="ava" />
                                </div>
                            </div>
