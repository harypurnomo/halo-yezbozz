...
<!-- start hero -->
<div id="hero" class="jarallax" data-speed="0.7" data-img-position="50% 80%" style="background-image: url({{asset('template/v2/img/intro_img/12.jpg')}});color: #333;">
    <div class="container">
        <div class="row">
                        ...
                        <aside class="sidebar goods-filter">
                            ...
                            <div class="goods-filter__inner">
                                                ...
                                                <div class="col-auto __image-wrap">
                                                    <figure class="__image">
                                                        <a href="single_product.html">
                                                            <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/5.jpg')}}" alt="demo" />
                                                        </a>
                                                    </figure>
                                                </div>
                                        ...
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col-auto __image-wrap">
                                                    <figure class="__image">
                                                        <a href="single_product.html">
                                                            <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/8.jpg')}}" alt="demo" />
                                                        </a>
                                                    </figure>
                                                </div>
                                        ...
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col-auto __image-wrap">
                                                    <figure class="__image">
                                                        <a href="single_product.html">
                                                            <img class="lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/2.jpg')}}" alt="demo" />
                                                        </a>
                                                    </figure>
                                                </div>
                                ...
                                <div class="widget widget--banner">
                                    <a href="#"><img class="img-fluid  lazy" src="{{asset('template/v2/img/blank.gif')}}" data-src="img/widget_banner_2.jpg" alt="demo" /></a>
                                </div>
                                <!-- end widget -->
                            </div>
                        </aside>
                            ...
                            <div class="__inner">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="188" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/1.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="180" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/2.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="160" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/3.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="190" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/4.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="180" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/5.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="180" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/6.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="250" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/7.jpg')}}" alt="demo" />
                                            </figure>
                                    ...
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <div class="__item">
                                            <figure class="__image">
                                                <img class="lazy" width="236" src="{{asset('template/v2/img/blank.gif')}}" data-src="{{asset('template/v2/img/goods_img/8.jpg')}}" alt="demo" />
                                            </figure>
