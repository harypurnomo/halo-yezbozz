	...
	<div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-market.store') }}" method="post" enctype="multipart/form-data">
                	{{ csrf_field() }}
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="company_name" id="company_name" class="form-control" placeholder="Your Company Name" value="{{ old('company_name') }}" required="" minlength="5" maxlength="100">
                        </div>

                        <div class="form-group">
                            <label>Email <span class="kt-font-danger">*</span></label>
                            <input type="email" name="email" class="form-control" placeholder="Your Email" value="{{ old('email') }}" required="" minlength="5" maxlength="100">
                        </div>

                        <div class="form-group">
                            <label>Phone Number <span class="kt-font-danger">*</span></label>
                            <input type="number" name="phone" class="form-control" placeholder="Your Phone Number" value="{{ old('phone') }}" required="" minlength="8" maxlength="30">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="market_brief_en" id="market_brief_en" class="form-control" maxlength="140" required="">{{ old('market_brief_en') }}</textarea>
                            <span id="char-market_brief_en">140</span> Character(s) Remaining
                        </div>
                        <div class="form-group">
                            <label>Market Brief ID <span class="kt-font-danger">*</span></label>
                            <textarea name="market_brief_id" id="market_brief_id" class="form-control" maxlength="140" required="">{{ old('market_brief_id') }}</textarea>
                            <span id="char-market_brief_id">140</span> Character(s) Remaining
                        </div>

                        <div class="form-group">
                            <label>Market Description EN</label>
                            <textarea name="market_desc_en" id="market_desc_en" class="form-control summernote">{{ old('market_desc_en') }}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Market Description ID</label>
                            <textarea name="market_desc_id" id="market_desc_id" class="form-control summernote">{{ old('market_desc_id') }}</textarea>
                        </div>
