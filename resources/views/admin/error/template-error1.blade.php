...
<html lang="en" >
    ...
    <head>
		...
		<link href="{{ url('admin/template/') }}/css/pages/error/error-5.css" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" href="{{ url('admin/template/') }}/media/logos/favicon.ico" />
</head>
    <!-- end::Head -->
	...
	<div class="kt-grid kt-grid--ver kt-grid--root">
		<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v5" style="background-image: url({{ url('admin/template/') }}/media/error/bg5.jpg);">
	<div class="kt-error_container">
		<span class="kt-error_title">
			<h1>Oops!</h1>		 
		</span> 		
		<p class="kt-error_subtitle" style="font-size: 1.7rem;">
			{{ $error }}
		</p>	
		<p class="kt-error_description" style="font-size: 1.3rem;">
			<a href="{{ url('/') }}/{{ $url }}"><< Back To List</a>
		</p>	 
	</div>	 
</div>	</div>
<!-- end:: Page -->
