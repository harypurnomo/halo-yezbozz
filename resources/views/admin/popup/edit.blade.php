    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main"> 
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Update Popup</span>
            </div>
        </div>
    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('manage-popup.update',['id'=>$recPopupById->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title"class="form-control" placeholder="Legalitas Title" value="{{ $recPopupById->title }}" required="">
                        </div>
                        <div class="form-group">
                            <label>Text Content <span class="kt-font-danger">*</span></label>
                            <textarea name="text_content" id="text_content" class="form-control summernote" required="">{!! $recPopupById->text_content !!}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Close Time (In Second) <span class="kt-font-danger">*</span></label>
                            <input type="number" name="close_time"class="form-control" placeholder="Close Time" value="{{ $recPopupById->close_time }}" required="">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="show_title" required="">
                                ...
                                <option value="1" {{ ($recPopupById->show_title==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recPopupById->show_title==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="">
                                <option value="">-- choose one of them --</option>
                                <option value="1" {{ ($recPopupById->is_active==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recPopupById->is_active==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>
