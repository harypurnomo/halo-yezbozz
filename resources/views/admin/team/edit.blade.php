    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('master-team.index') }}" class="btn kt-subheader__btn-primary">Back To List &nbsp;</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-team.update',['id'=>$recTeamByID->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    <div class="kt-portlet__body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Your Name" value="{{ $recTeamByID->name }}" required="" minlength="5" maxlength="100">
                        </div>
                        <div class="form-group">
                            <label>Title <span class="kt-font-danger">*</span></label>
                            <input type="text" name="title" class="form-control" placeholder="Your Title" value="{{ $recTeamByID->title }}" required="" minlength="5" maxlength="100">
                        </div>

                        <div class="form-group">
                            <label>Team <span class="kt-font-danger">*</span></label>
                            <div class="col-4">
                                <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar">
                                    @if($recTeamByID->picture=='')
                                    <div class="kt-avatar__holder" style="background-image: url({{ asset('admin/template/client/noimage.png') }});"></div>
                                    @else
                                    <div class="kt-avatar__holder" style="background-image: url({{ url('uploads/team') }}/{{ $recTeamByID->picture }})"></div>
                                    @endif
                            ...
                            <small>The best size 275x344</small>
                        </div>

                        <div class="form-group">
                            <label>Sort <span class="kt-font-danger">*</span></label>
                            <input type="number" name="sort" class="form-control" placeholder="Your Sort" value="{{ $recTeamByID->sort }}" required="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="">
                                ...
                                <option value="1" {{ ($recTeamByID->is_active==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recTeamByID->is_active==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>
