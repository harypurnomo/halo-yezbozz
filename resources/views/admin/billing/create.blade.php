	...
	<div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-billing.store') }}" method="post" enctype="multipart/form-data">
                	{{ csrf_field() }}
                    <div class="kt-portlet__body">
                    	@if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="billing_number" class="form-control" placeholder="{{ Library::modules(Request::segment(1).'/'.Request::segment(2))[0]->module_name }} Number" value="{{ old('billing_number') }}" required="" minlength="3" maxlength="50">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="invoice_range" class="form-control col-6" id="kt_daterangepicker_1" value="{{ old('invoice_range') }}" readonly="" required="">
                            <small>Format : month/date/year</small>
                        </div>

                        <div class="form-group">
                            <label>Total (format rupiah) <span class="kt-font-danger">*</span></label>
                            <input type="text" name="total" class="form-control input-numeral col-4" value="{{ old('total') }}" required="" placeholder="Total">
                        </div>

                        <div class="form-group">
                            <label>Notes / Terms</label>
                            <textarea name="desc" id="desc" class="form-control" minlength="5">{{ old('desc') }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="is_active" class="row col-12">File {{ Library::modules(Request::segment(1).'/'.Request::segment(2))[0]->module_name }} </label>
