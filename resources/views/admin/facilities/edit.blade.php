    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-facilities.update',['id'=>$recFacilitiesByID->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    <div class="kt-portlet__body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Your Title" value="{{ $recFacilitiesByID->title }}" required="" minlength="5" maxlength="100">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-4">
                                <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar">
                                    @if($recFacilitiesByID->picture=='')
                                    <div class="kt-avatar__holder" style="background-image: url({{ asset('admin/template/client/noimage.png') }});"></div>
                                    @else
                                    <div class="kt-avatar__holder" style="background-image: url({{ url('uploads/facilities') }}/{{ $recFacilitiesByID->picture }})"></div>
                                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="sort" class="form-control" placeholder="Your Sort" value="{{ $recFacilitiesByID->sort }}" required="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="">
                                ...
                                <option value="1" {{ ($recFacilitiesByID->is_active==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recFacilitiesByID->is_active==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>
