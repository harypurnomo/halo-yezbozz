    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('master-type-of-tenant.index') }}" class="btn kt-subheader__btn-primary">Back To List &nbsp;</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-type-of-tenant.update',['id'=>$recTenantsTypeByID->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    <div class="kt-portlet__body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $recTenantsTypeByID->name }}" placeholder="Your Category Name" required="" minlength="5" maxlength="50">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="">
                                ...
                                <option value="1" {{ ($recTenantsTypeByID->is_active==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recTenantsTypeByID->is_active==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>
