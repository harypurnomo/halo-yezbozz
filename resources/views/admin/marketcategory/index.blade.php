        ...
        <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="{{ route('master-category-of-market.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable simple-datatable">
                    ...
                    <tbody>
                        @foreach ($recMarketCategory as $index => $row)
                        <tr>
                            <td>{{ ++$index }}</td>
                            <td><a href="{{ route('master-category-of-market.edit',['id'=>$row->id]) }}">{{ $row->name }}</a></td>
                            ...
                            <td>
                                <span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill delete-link" data-id="{{ $row->id }}" data-link="administrator/master-category-of-market">
