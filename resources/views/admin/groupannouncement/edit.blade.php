    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-group-announcement.update',['id'=>$recGroupsAnnouncementByID->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    <div class="kt-portlet__body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $recGroupsAnnouncementByID->name }}" placeholder="Your Group Name" required="">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="">
                                ...
                                <option value="1" {{ ($recGroupsAnnouncementByID->is_active==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recGroupsAnnouncementByID->is_active==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>
