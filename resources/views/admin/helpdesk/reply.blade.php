    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('open-ticket.show',['id'=>base64_encode($recHelpdeskById->id)]) }}" class="btn kt-subheader__btn-primary">Back&nbsp;</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('open-ticket.update',['id'=>$recHelpdeskById->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    ...
                    <input type="hidden" name="receiver_user_id" value="{{ $recHelpdeskById->sender_user_id }}">
                    <input type="hidden" name="receiver_name" value="{{ $recHelpdeskById->sender_name }}">
                    <input type="hidden" name="receiver_email" value="{{ $recHelpdeskById->sender_email }}">
