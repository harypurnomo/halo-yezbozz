                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="{{ route('open-ticket-by-me.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable simple-datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ ++$index }}</td>
                            <td><a href="{{ route('open-ticket-by-me.show',['id'=>base64_encode($row->id)]) }}">
                                @if ($row->is_read_member==0)
                                <b>{{ $row->message }}</b>
                                @else
                                {{ $row->message }}
                                @endif
