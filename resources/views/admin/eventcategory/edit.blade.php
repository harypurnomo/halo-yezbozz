    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('master-category-of-event.index') }}" class="btn kt-subheader__btn-primary">Back To List &nbsp;</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-category-of-event.update',['id'=>$recEventsCategoryByID->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    <div class="kt-portlet__body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $recEventsCategoryByID->name }}" placeholder="Your Category Name" required="" minlength="5" maxlength="50">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="">
                                ...
                                <option value="1" {{ ($recEventsCategoryByID->is_active==1)?'selected':'' }}>Yes</option>
                                <option value="0" {{ ($recEventsCategoryByID->is_active==0)?'selected':'' }}>No</option>
                            </select>
                        </div>
                    </div>
