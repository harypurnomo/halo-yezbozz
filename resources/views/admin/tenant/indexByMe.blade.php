                ...
                {{-- <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="{{ route('master-tenant-by-me.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable simple-datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ ++$index }}</td>
                            <td><a href="{{ route('master-tenant-by-me.edit',['id'=>base64_encode($row->id)]) }}">{{ $row->name }}</a></td>
                            <td>{{ $row->type_name }}</td>
                            <td>{{ $row->address }}</td>
