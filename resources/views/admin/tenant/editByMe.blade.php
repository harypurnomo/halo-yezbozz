    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('master-tenant-by-me.index') }}" class="btn kt-subheader__btn-primary">Back To List &nbsp;</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-tenant-by-me.update',['id'=>$recTenantsByID->id]) }}" method="post" enctype="multipart/form-data">
                    {{method_field('PUT')}}
                    {{ csrf_field() }}
                    <div class="kt-portlet__body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Company Name" value="{{ $recTenantsByID->name }}" required="" minlength="5" maxlength="50">
                        </div>

                        <div class="form-group">
                            <label for="is_active">Category of Company <span class="kt-font-danger">*</span></label>
                            <select class="form-control col-4" name="tenant_type_id" required="" disabled="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control" required="" rows="5">{{ $recTenantsByID->address }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Email <span class="kt-font-danger">*</span></label>
                            <input type="email" name="email" class="form-control" placeholder="Your Email" value="{{ $recTenantsByID->email }}" required="">
                        </div>

                        <div class="form-group">
                            <label>Phone Number <span class="kt-font-danger">*</span></label>
                            <input type="text" name="phone" class="form-control" placeholder="Your Phone Number" value="{{ $recTenantsByID->phone }}" required="" maxlength="25">
                        </div>

                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" name="fax" class="form-control" placeholder="Your Fax" value="{{ $recTenantsByID->fax }}" maxlength="25">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="is_active" required="" disabled="">
                                <option value="">-- choose one of them --</option>
