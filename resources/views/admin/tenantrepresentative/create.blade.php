	...
	<div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-tenant-representative.store') }}" method="post" enctype="multipart/form-data">
                	{{ csrf_field() }}
                    <div class="kt-portlet__body">
                    	@if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control col-4" name="user_id" required="">
                                ...
                                @foreach ($recUser as $element)
                                    <option value="{{ $element->id }}" {{(old('user_id')==$element->id)?'selected':''}}>{{ $element->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" placeholder="Your Description" value="{{ old('description') }}">
                        </div>
                        <div class="form-group">
