	...
	<div class="row">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('master-type.store') }}" method="post">
                	{{ csrf_field() }}
                    <div class="kt-portlet__body">
	                    ...
	                    <div class="form-group">
                            ...
                            <input type="text" name="type_name" class="form-control" placeholder="Your Type" value="{{ old('type_name') }}" required="" minlength="5" maxlength="50">
                        </div>
